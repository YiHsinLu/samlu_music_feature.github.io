...
## **【第8週-女 43：極速超跑 vs 臺北鯨華 (12月16日)】**{.tabset}
...
MatchPlotly_positions_8%>% layout(autosize = F, width = 1000, height = 1000)
```
...
```{r warning=FALSE, message=FALSE, echo=FALSE}
MatchPlotly_teams_8%>% layout(autosize = F, width = 1000, height = 1000)
```
