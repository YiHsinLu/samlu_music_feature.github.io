...
## **【第8週-女 46：臺北鯨華 vs 凱撒飯店連鎖 (12月17日)】**{.tabset}
...
MatchPlotly_positions_9%>% layout(autosize = F, width = 1000, height = 1000)
```
...
```{r warning=FALSE, message=FALSE, echo=FALSE}
MatchPlotly_teams_9%>% layout(autosize = F, width = 1000, height = 1000)
```
