...
```{r}
Match78_plrStat = read.csv('Matches/players/第13週-女 78：新北中纖 vs 臺北鯨華 (01月28日).csv', header = T)
Match78_rlt = read.csv('Matches/results/第13週-女 78：新北中纖 vs 臺北鯨華 (01月28日).csv', header = T, row.names = 1)
```
...
for(mach in c(1)){
  ...
  c(
    ...
    round(sum(Match_TKW[[mach]]$team_stat$tkw$dig_success[Match_TKW[[mach]]$team_stat$tkw$position=="舉球"])/sum(Match_TKW[[mach]]$team_stat$tkw$dig_total[Match_TKW[[mach]]$team_stat$tkw$position=="長攻"]), digits = 2)
  ),
  c(
...
AGN_stat = list(
  ...
  c(
    ...
    round(sum(Match_TKW[[mach]]$team_stat$agn$dig_success[Match_TKW[[mach]]$team_stat$agn$position=="舉球"])/sum(Match_TKW[[mach]]$team_stat$agn$dig_total[Match_TKW[[mach]]$team_stat$agn$position=="長攻"]), digits = 2)
  ),
  c(
