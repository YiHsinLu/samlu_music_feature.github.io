...
```{r}
Match78_plrStat = read.csv('Matches/players/第1週-女 2：臺北鯨華 vs 高雄台電 (10月14日).csv', header = T)
Match78_rlt = read.csv('Matches/results/第1週-女 2：臺北鯨華 vs 高雄台電 (10月14日).csv', header = T, row.names = 1)
```
